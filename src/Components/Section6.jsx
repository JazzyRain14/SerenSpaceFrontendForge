    ...
    return (
        <div className='h-full w-full py-10 px-[28px] bg-secondary'>
            <div className='flex items-center justify-between mb-6'>
                <h1 className='w-1/2 font-LibreBold text-[28px]'>Whatever the challenge is, it can be solved.</h1>
                <button className='bg-primary py-3 px-5 rounded-full font-RedHat text-white'>Explore all</button>
            </div>
            <div className='grid grid-cols-2 lg:grid-cols-4 gap-5'>
                ...
                <div className='flex flex-col h-[400px] max-w-[300px]'>
                    ...
                    <footer className='flex-1 relative'>
                        ...
                        <span className='absolute bottom-0 text-sm font-RedHat'>Learn more</span>
                    </footer>
                </div>
                {/* card */}
                <div className='flex flex-col max-w-[300px] h-[400px] '>
                    ...
                    <footer className='flex-1 relative'>
                        ...
                        <p className='font-RedHat leading-5 mb-5'>A group of mental illness</p>
                        <span className='absolute bottom-0 text-sm font-RedHat'>Learn more</span>
                    </footer>
                </div>
                {/* card */}
