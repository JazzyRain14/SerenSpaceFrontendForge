        ...
        <div className="flex flex-col gap-10 w-1/2 px-4">
          ...
          <div className="flex flex-col gap-4">
            <p className="font-semibold font-RedHat">
              At SerenSpace, we connect you with qualified, experienced, and
              compassionate therapists dedicated to your mental well-being.
              Trust that your mental health journey is in capable hands,
              ensuring you receive the best support and guidance.
            </p>
            <p className="font-semibold font-RedHat">
              With our therapists, you can expect the same level of
              professionalism and quality as you would from an in-office
              therapist, with the added convenience of flexible communication
              options.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-10 w-1/2 px-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="flex items-center gap-2 text-brown-black text-xl">
              <span>
                <img src={Questionmark} alt="" width={30} />
              </span>
              24/7 Support
            </p>
          </div>
